            ...
            <div>
              ...
              {isOwner && (
                <div className="d-flex gap-2 mt-3">
                  <button className="btn btn-outline-primary" onClick={() => navigate(`/edit/${id}`)}>
                    <i className="bi bi-pencil me-1"></i>Edit Recipe
                  </button>
                  <button className="btn btn-outline-danger" onClick={handleDelete}>
                    <i className="bi bi-trash me-1"></i>Delete Recipe
                  </button>
                </div>
              )}
            </div>
              ...
              <div className="mb-4">
                ...
                <div className="d-flex flex-wrap gap-2">
                  {recipe.tags.split(',').map((tag, index) => (
                    <span key={index} className="bg-light p-3 rounded-3">{tag.trim()}</span>
                  ))}
                </div>
              </div>
            )}
